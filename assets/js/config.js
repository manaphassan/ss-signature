...
const CONFIG = {
    ...
    // Office/Address selections
    offices: [
        {
            id: 'SSH',
            name: 'SuamiSihat Holding Sdn Bhd',
            address: 'Lot 8-3A, Level 1, UOA Business Park, Jalan Pengaturcara U1/51A, Seksyen U1, 40150 Shah Alam, Selangor Darul Ehsan.',
            ...
            address: 'Lot 8-3A, Level 1, UOA Business Park, Jalan Pengaturcara U1/51A, Seksyen U1, 40150 Shah Alam, Selangor Darul Ehsan.',
            phone: '+60 3 6044 1878',
            logoUrl: 'assets/img/company/logo_ssc_secondary_dark.svg',
            logoLightUrl: 'assets/img/company/logo_ssc_secondary_light.svg'         
        }, {
            id: 'SSE',
            name: 'SuamiSihat Ecommerce Sdn Bhd',
            address: 'No. 9, Tingkat 2 Jalan Kemboja 33, Taman Aman, 42700 Banting, Selangor Darul Ehsan.',
            phone: '+60 7 6044 1878',
            logoUrl: 'assets/img/company/logo_sse_secondary_dark.svg',
            logoLightUrl: 'assets/img/company/logo_sse_secondary_light.svg'
        }, {
            id: 'SSW',
            name: 'SuamiSihat Wellness Sdn Bhd',
            address: 'Lot 9-3A, Level 1, UOA Business Park, Jalan Pengaturcara U1/51A, Seksyen U1, 40150 Shah Alam, Selangor Darul Ehsan.',
            phone: '+60 3 6044 1878',
            logoUrl: 'assets/img/company/logo_ssw_secondary_dark.svg',
            logoLightUrl: 'assets/img/company/logo_ssw_secondary_light.svg'
        }, {            
             id: 'SST',
            name: 'SuamiSihat Technology Sdn Bhd',
            address: 'No. 7, Tingkat 2 Jalan Kemboja 33, Taman Aman, 42700 Banting, Selangor Darul Ehsan.',
            phone: '+60 7 6044 1878',
            logoUrl: 'assets/img/company/logo_sst_secondary_dark.svg',
            logoLightUrl: 'assets/img/company/logo_sst_secondary_light.svg' 
        }
    ...
    socialMedia: {
        facebook: {
            ...
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#21A1F7"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>`
        },
        twitter: {
            name: 'x',
        ...
        linkedin: {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/suamisihat',
        ...
        tiktok: {
            name: 'TikTok',
            url: 'https://www.tiktok.com/@suamisihatstore',
    ...
    branding: {
        ...
        lion: '#BD9A73',                // Lion
        fawn: '#CCAC8D',                // Fawn
        arylideYellow: '#E5D15C',       // Arylide Yellow
        bananaYellow: '#FCE53D',        // Banana Yellow
        
        // Neutral Colors
        black: '#000000',               // Black
        grey20: '#CCCCCC',              // Grey 20
        grey40: '#999999',              // Grey 40
        grey60: '#666666',              // Grey 60
        grey80: '#575756',              // Grey 80
        grey90: '#3C3C3B',              // Grey 90
        white: '#ffffff',               // White
        ...
        bannerLink: 'https://www.suamisihat.com',
        companyName: 'SS Health'
    },
